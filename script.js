...
function enterSite(){document.getElementById("gate")?.classList.add("hide");sessionStorage.setItem("brath_entered","1")}
if(sessionStorage.getItem("brath_entered")) document.getElementById("gate")?.classList.add("hide");
function enterAndLogin(){enterSite()}
